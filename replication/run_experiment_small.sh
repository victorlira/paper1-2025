...
DATASET_ZIP_URL="https://anonymous.4open.science/api/repo/small-dataset-F10F/zip"
./get-dataset.sh "$DATASET_ZIP_URL"

INPUT_CSV="experiment-small/results-with-build-information.csv"
OUTPUT_DIR="output/data"
OUTPUT_CSV="$OUTPUT_DIR/results-with-build-information.csv"
RESULTS_DIR="experiment-small"
...
while IFS= read -r line; do
  ...
  "$JDK21_BIN" -jar dependencies/refactoring-analyser-1.0-SNAPSHOT-jar-with-dependencies.jar \
     "$SCRIPT_DIR/experiment-small" "$counter"
